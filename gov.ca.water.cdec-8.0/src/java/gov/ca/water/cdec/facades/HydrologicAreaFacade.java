...
import gov.ca.water.cdec.entities.HydrologicArea;
 ...
 */
@Stateless
public class HydrologicAreaFacade extends CdecBaseFacade<HydrologicArea> {
  ...
  public HydrologicAreaFacade() {
    super(HydrologicArea.class);
  }
  //</editor-fold>
