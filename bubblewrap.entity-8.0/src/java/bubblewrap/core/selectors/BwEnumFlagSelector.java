 ...
 */
public class BwEnumFlagSelector<TItem extends BwEnumFlag<TItem>> 
                                                          extends Selector<TItem> {
   ...
   */
  public BwEnumFlagSelector(Class<? extends TItem> enumClass) {
    super();
  ...
  public void setSelectedItem(TItem selectedItem) {
    String ordStr =
         (selectedItem == null)? null: Integer.toString(selectedItem.value.intValue());
  ...
  protected SelectItem newSelectOption(TItem selectOption) {
    ...
    if (selectOption != null) {
      String selectId = Integer.toString(selectOption.value.intValue());
