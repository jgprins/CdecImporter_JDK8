...
/**
 * A FieldValueConverter for Long field values.  See {@linkplain
 * #onSetOptions(org.json.JSONObject) onSetOptions} for details on the supported
 * conversion options.
 * @author J.G. "Koos" Prins, D.Eng. PE.
 */
public class LongValueConverter extends FieldValueConverter<Long> {
  ...
  /**
   * Check if the Long String should include a Thousand Separator
   * @return 
   */
   ...
   */
  @Override
  public Long toFieldValue(Object value) {
    Long result = null;
    if (value != null) {
      if (value instanceof String) {
        ...
        if (strVal != null) {
          result = DataConverter.toValue(strVal, Long.class);          
        }
      } else if (value instanceof Long) {
        result = (Long) value;
      } else if (value instanceof Number) {
        Number numVal = (Number) value;
        result = DataConverter.convertTo(numVal, Long.class);
      }
    }
    return result;
  }
   ...
   * {@inheritDoc}
   * <p>
   * OVERRIDE: return the formatted string of a Long or Numeric value rounded to an 
   * Long or return the value is it is a String, else return this.nullValue</p>
   */
  @Override
  public String toStringValue(Object value) {
    ...
    if (value != null) {
      if (value instanceof String) {
        lngVal =this.toFieldValue(value);
      }
    } else {
      if (value instanceof Long) {
        ...
        Number numVal = (Number) value;
        lngVal = DataConverter.convertTo(numVal, Long.class);
      }
    }
    if (lngVal != null) {
