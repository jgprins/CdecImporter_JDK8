 ...
 */
public abstract class EntityMergeDelegate<TSrc, TTrg extends Serializable> {
   ...
   * @param srcObject the Source Object can be a trgBean type or any other object type 
   * (e.g. a JSON Object)
   ...
   * @throws Exception to break out and rollback the entity merges.
   */
  public abstract TTrg newMerge(TSrc srcObject) throws Exception;
  // </editor-fold>
}
